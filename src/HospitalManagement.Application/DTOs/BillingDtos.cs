...
public class BillListDto : BillSummaryDto { public int PatientId { get; set; } public int? AppointmentId { get; set; } public string PatientName { get; set; } = string.Empty; public DateTime BillDate { get; set; } }
